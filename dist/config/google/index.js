...
exports.calendar = exports.setCredentialsForUser = exports.getAuthUrl = exports.TOKEN_PATH = exports.SCOPES = exports.oauth2Client = void 0;
...
const setCredentialsForUser = (slackUserId) => {
    const token = (0, tokenStorage_1.getToken)(slackUserId);
    if (!token)
        return;
